...
var getJsonCallBack = function(data) {
	...
	for ( var i = 0; i < data.length; i++) {
		...
		data[i].url = url;
		data[i].name=name;
		outputFileArray.push(data[i].name);
		$.ajax({
			type : "GET",
			async : false,
			url : url,
		...
		$("#filenames").append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=checkbox  id="+data[i].name+" value='"+data[i].name+"'>"+data[i].name+"</input><br>");
		
	}
	$("#filenames").append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img type=image src='images/bd.jpg' style='vertical-align:middle;'  onclick=ff() ></img>");
...
$(function() {
	...
	$('#file_upload').uploadify({
		...
		'uploader' : 'fmpttp.action?m=frontUpdateFileBiDui',
