...
function eXcell_myCalender(cell){                                 
    ...
    this.edit=function(){
        ...
        this.cell.innerHTML="<input type=\"text\" id='ddd' style='border:0; width: 100%;' onfocus=\"WdatePicker({skin:'whyGreen',isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd'});\" >";
