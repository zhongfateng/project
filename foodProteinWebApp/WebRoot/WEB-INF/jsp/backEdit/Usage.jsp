			...
			<tr class="tr_title">
				...
				<td background="${skinPath}images/manage/dh_bg.jpg">
					<img src="${skinPath}/images/manage/dh-bg0.gif" width="14"
						height="14" />
					<font color="#016250"> 当前位置信息:后台用户须知上传</font>
				</td>
			</tr>
		</table>
		<div style="overFlow: auto; height: 550px">

<form name="example" method="post" action="usage.action?m=save" id="f">
				<table width="100%" align="center" class="table_nbw">
					
					
					
					<tr><td><input type="hidden" id="d3_2" name="id"
								size="40%"  value="${usage.id}" /></td>
							</tr>
					...
					<tr>
						<td height="30" class="td_nbw_right" align="center" colspan="2">
							<textarea name="body"  id="textarea" cols="100" rows="8" style="width:100%;height:400px;visibility:hidden;" >${usage.body} </textarea>
							<br />
