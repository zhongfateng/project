...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100%" valign="top" bgcolor="#FFFFFF" style="padding-left:5px">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="35" background="<%=request.getContextPath() %>/resources/images/myCenter/images/leftmenu-bg.jpg" class="hei16B">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我的上传记录</td>
        </tr>
      </table>
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr  onmousemove="javascript:changebg(this,0)" style="backgroud-color:#f4f4f4" onmouseout="javascript:changebg(this,1)">
                ...
                <td width="350" height="50" align="center" background="<%=request.getContextPath() %>/resources/images/myCenter/images/bg_repeat.png" bgcolor="#4E85E2" class="hei14">标题&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
              </tr>
              </table>
              ...
              <tr  onmousemove="javascript:changebg(this,0)" style="backgroud-color:#f4f4f4" onmouseout="javascript:changebg(this,1)">
                ...
                <td width="100" height="50" align="center" class="hei14">${ff.timestamp}</td>
                <td width="50" height="50" align="center" class="hei14">${ff.ftype}</td>
...
<script type="text/javascript">
	function changepage(pid){
	    if(pid=='1'){
	    	window.location.href="fmptJf.action?m=frontUploadAndDownload&fclick=upload&page=1";
	    }
	    if(pid=='2'){
	    	window.location="fmptJf.action?m=frontUploadAndDownload&fclick=upload&page=${dataList.currentPage-1}";
	    }
	    if(pid=='3'){
	    	window.location="fmptJf.action?m=frontUploadAndDownload&fclick=upload&page=${dataList.currentPage+1}";
	    }
	    if(pid=='4'){
	   		window.location="fmptJf.action?m=frontUploadAndDownload&fclick=upload&page=${dataList.totalPage}";
	    }
	}
</script>
