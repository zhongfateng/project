...
<table width="965" height="692" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="734" height="692" valign="top"><table width="734" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="35" background="<%=request.getContextPath()%>/resources/images/cds/images/leftmenu-bg-protein.jpg" class="orange14B">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Summary</td>
     </tr>
    </table>
      <table width="734" border="0" cellpadding="0" cellspacing="0" style="border:solid; border-color:#d0ced1; border-width:0px 1px 1px 1px">
        <tr>
          <td valign="top" bgcolor="#FFFCF9"><table width="100%" height="61" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="33%" align="right" valign="top" class="eng14" style="padding:20px 10px;"><strong>
                  ...
                  Ncbi   species ID：<br />
                  Note：</strong></td>
              <td width="67%" align="left" valign="top" style="padding:20px 10px;" class="eng14">${protein.pid}<br />
                ${protein.chromosomeRef}<br />
                ${protein.chromosomeStart}<br />
                ${protein.chromosomeEnd}<br />
                ${protein.ncbiProteinRef}<br />
                <a href="gene.action?m=frontGeneDetail&ncbiGeneRef=${protein.geneId}">${protein.geneId}</a><br />
                ${protein.speciesId}<br />
                ${protein.organism}<br/>
				<a href="http://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?id=${protein.ncbiSpeciesId}" target="_blank">${protein.ncbiSpeciesId}
				</a><br/>
				${protein.note}
				</td>
            </tr>
      ...
      <table width="734" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="35" background="<%=request.getContextPath()%>/resources/images/cds/images/leftmenu-bg-protein.jpg" class="orange14B">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sequence </td>
        </tr>
      </table>
      <table width="734" border="0" cellpadding="0" cellspacing="0" style="border:solid; border-color:#d0ced1; border-width:0px 1px 1px 1px">
        <tr>
          <td valign="top" bgcolor="#FFFCF9" style="padding:20px 0">
          <table width="100%" height="150" border="0" cellpadding="0" cellspacing="0">
           
           
           <%
           		//根据组的总数分成每5组为一行     最后一行不满5组的也算一行
				...
				for(int j=0;j<rowSize;j++){
					...
					if(j==rowSize-1){//当到最后一行时，判断剩下的组数，分别显示
			%>
			<tr>
      ...
      <table width="734" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="35" background="<%=request.getContextPath()%>/resources/images/cds/images/leftmenu-bg-protein.jpg" class="orange14B">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Related Bibliography</td>
        </tr>
      </table>
      <table width="734" border="0" cellpadding="0" cellspacing="0" style="border:solid; border-color:#d0ced1; border-width:0px 1px 1px 1px">
        <tr>
          <td valign="top" bgcolor="#FFFCF9">
        ...
        <tr>
          <td valign="top">
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="dd_00">
                ...
                <tr>
                  <td width="100%" height="30" bgcolor="#FBF0B5" class="hei14" align="center">找到<span class="lanlink" id="d_sum">${pageBean.allRow}</span>条数据，<a href="protein.action?m=frontProteinDocList&proteinId=${protein.ncbiProteinRef}&page=1&pageSize=10">显示更多</a>&nbsp;&nbsp;
                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
    ...
    <td width="226" valign="top" bgcolor="#FFFFFF" style="padding-left:5px">
	  <table width="100%" cellspacing="0" background="<%=request.getContextPath()%>/resources/images/cds/images/right-bg-protein.jpg">
        <tr>
      ...
      <table width="100%" cellspacing="0">
        <tr>
          <td height="30" style="padding-left: 20px;" background="<%=request.getContextPath()%>/resources/images/cds/images/right-bg-protein.jpg"><span class="bai14">相关数据库检索
</span></td>
        </tr>
      </table>
