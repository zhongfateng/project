...
<script type="text/javascript">
	$(function(){
		...
		$("#select").change(function(){
			...
			window.location.href="protein.action?m=frontProteinDocList&proteinId=${protein.ncbiProteinRef}&page=1&pageSize="+pageSize;
		});
        ...
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <c:forEach items="${pageBean.list}" var="pp" begin="0" varStatus="i">
                ...
                <tr>
              <td align="left" valign="top" class="eng14" style="height: 60px;">
              &nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
	function changepage(pid){
	    ...
	    if(pid=='1'){
	    	window.location.href="protein.action?m=frontProteinDocList&page=1&proteinId=${protein.ncbiProteinRef}&pageSize="+pageSize;
	    }
	    if(pid=='2'){
	    	window.location="protein.action?m=frontProteinDocList&page=${pageBean.currentPage-1}&proteinId=${protein.ncbiProteinRef}&pageSize="+pageSize;
	    }
	    if(pid=='3'){
	    	window.location="protein.action?m=frontProteinDocList&page=${pageBean.currentPage+1}&proteinId=${protein.ncbiProteinRef}&pageSize="+pageSize;
	    }
	    if(pid=='4'){
	   		window.location="protein.action?m=frontProteinDocList&page=${pageBean.totalPage}&proteinId=${protein.ncbiProteinRef}&pageSize="+pageSize;
	    }
	}
</script>
</body>
