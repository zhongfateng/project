...
function tihuan(td){
  ...
  {
    tr[ii].className = (td.cellIndex==ii)?"tag1_01A":"tag1_02A";
...
<script type="text/javascript">
	$(function(){
		...
		$("#d2_1").click(function(){
			...
			}else if(dd_1=="ProteinID"){
				ProteinID = $("#ddd_1").val();
			}else if(dd_1=="NcbiProteinRef"){
				NcbiProteinRef = $("#ddd_1").val();
			}
			...
			}else if(dd_2=="ProteinID"){
				ProteinID = $("#ddd_2").val();
			}else if(dd_2=="NcbiProteinRef"){
				NcbiProteinRef = $("#ddd_2").val();
			}
			...
			}else if(dd_3=="ProteinID"){
				ProteinID = $("#ddd_3").val();
			}else if(dd_3=="NcbiProteinRef"){
				NcbiProteinRef = $("#ddd_3").val();
			}
			...
			}else if(dd_4=="ProteinID"){
				ProteinID = $("#ddd_4").val();
			}else if(dd_4=="NcbiProteinRef"){
				NcbiProteinRef = $("#ddd_4").val();
			}
			...
			if(dd_1==dd_2||dd_1==dd_3||dd_1==dd_4||dd_2==dd_3||dd_2==dd_4||dd_3==dd_4){
				...
				window.location.href="protein.action?m=frontAdProteinList&NCBISpeciesID="+NCBISpeciesID+"&chromosomeRef="+chromosomeRef+"&ProteinID="+ProteinID+"&NcbiProteinRef="+NcbiProteinRef+"&key_1="+key_1+"&key_2="+key_2+"&key_3="+key_3;
			}
		});
	});
...
<table width="965" height="32" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="84%"><table width="360" border="0" cellspacing="1"  class="tag1">
      <tr>
        <td height="28" align="center" bgcolor="#bbbbbb" class="tag1_01A"  onmouseover="tihuan(this)" ><span class="bai14">标准检索</span></td>
...
<table width="965" height="65" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="cccccc">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tag1_04" id="obody">
      <tr>
        <td bgcolor="fdeddd" class="hei14" style="padding:45px 15px;">
          ...
          <tr>
            ...
            <td width="300" align="center"><a href="javascript:;" id="d1_1"><img src="<%=request.getContextPath()%>/resources/images/cds/images/search-menu-protein.jpg" width="102" height="35" border="0" /></a>&nbsp;&nbsp;<a href="indexMain.action?m=frontIndexMain"><img src="<%=request.getContextPath()%>/resources/images/cds/images/login-cancle.jpg" width="102" height="35" border="0" /></a></td>
            </tr>
        </table>
        <br/>
        <br />
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FEF4B1">
                <tr>
                  <td bgcolor="#FFFFEE"  class="hei14" style="padding:15px;"><p class="stitle" >数据库简介</p>
                      <p class="hei12"> &nbsp;&nbsp;&nbsp;&nbsp;蛋白质序列数据库专门存储完整测序的食品微生物蛋白质序列信息的数据库，除了提供蛋白质序列ID、染色体ID、起始位点、物种ID、注释等基本信息外，还提供具体的序列以及相关文献等信息。</p></td>
                </tr>
          </table>
		</td>
      </tr>
      <tr style="display: none">
        <td bgcolor="fdeddd"   class="hei14" style="padding:15px;"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td height="50">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <select name="select3" id="dd_1" style="height:30px; width:180px; border:solid 1px #CCCCCC;">
               <option value="NCBISpeciesID">NCBISpeciesID</option>
                ...
                <option value="NcbiProteinRef">NcbiProteinRef</option>
               </select>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input class="TxtUserNameCssClass" id="ddd_1" name="0122" style="height:30px; width:180px; border:solid 1px #CCCCCC;"/></td>
          </tr>
          <tr onmousemove="javascript:changebg(this,0)" style="backgroud-color:#f4f4f4" onmouseout="javascript:changebg(this,1)">
            <td>&nbsp;</td>
            <td height="50"><select name="select4" id="key_1" style="height:30px; border:solid 1px #CCCCCC;">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input class="TxtUserNameCssClass" id="ddd_2" name="012" style="height:30px; width:180px; border:solid 1px #CCCCCC;"/></td>
          </tr>
          <tr onmousemove="javascript:changebg(this,0)" style="backgroud-color:#f4f4f4" onmouseout="javascript:changebg(this,1)">
            <td>&nbsp;</td>
            <td height="50"><select name="select" id="key_2" style="height:30px; border:solid 1px #CCCCCC;">
              <option value="and">AND</option>
              <option value="or">OR</option>
            </select>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input class="TxtUserNameCssClass" id="ddd_3" name="01" style="height:30px; width:180px; border:solid 1px #CCCCCC;" />            </td>
          </tr>
          <tr onmousemove="javascript:changebg(this,0)" style="backgroud-color:#f4f4f4" onmouseout="javascript:changebg(this,1)">
            <td>&nbsp;</td>
            <td height="50"><select name="select2" id="key_3" style="height:30px; border:solid 1px #CCCCCC;">
              <option value="and">AND</option>
              <option value="or">OR</option>
            </select>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input class="TxtUserNameCssClass" id="ddd_4" name="907" style="height:30px; width:180px; border:solid 1px #CCCCCC;"/>            </td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td height="90" align="center"><a href="javascript:;" id="d2_1"><img src="<%=request.getContextPath()%>/resources/images/cds/images/search-menu-protein.jpg" width="102" height="35" border="0" /></a>&nbsp;<a href="indexMain.action?m=frontIndexMain"><img src="<%=request.getContextPath()%>/resources/images/cds/images/login-cancle.jpg" width="102" height="35" border="0"/></a></td>
          </tr>
        </table>
              <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FEF4B1">
                <tr>
