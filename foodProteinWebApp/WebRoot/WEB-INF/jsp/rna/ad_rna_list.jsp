...
<script type="text/javascript">
	$(function(){
		...
		$("#select").change(function(){
			...
			window.location.href="rna.action?m=frontAdRnaList&NCBISpeciesID=<%=request.getAttribute("NCBISpeciesID")%>&page=1&pageSize="+pageSize+"&chromosomeRef=<%=request.getAttribute("chromosomeRef")%>&rnaID=<%=request.getAttribute("rnaID")%>";
		});
...
<script type="text/javascript">
	function changepage(pid){
	    ...
	    if(pid=='1'){
	    	window.location.href="rna.action?m=frontAdRnaList&page=1&NCBISpeciesID=<%=request.getAttribute("NCBISpeciesID")%>&pageSize="+pageSize;
	    }
	    if(pid=='2'){
	    	window.location="rna.action?m=frontAdRnaList&page=${dataList.currentPage-1}&NCBISpeciesID=<%=request.getAttribute("NCBISpeciesID")%>&pageSize="+pageSize+"&chromosomeRef=<%=request.getAttribute("chromosomeRef")%>&rnaID=<%=request.getAttribute("rnaID")%>";
	    }
	    if(pid=='3'){
	    	window.location="rna.action?m=frontAdRnaList&page=${dataList.currentPage+1}&NCBISpeciesID=<%=request.getAttribute("NCBISpeciesID")%>&pageSize="+pageSize+"&chromosomeRef=<%=request.getAttribute("chromosomeRef")%>&rnaID=<%=request.getAttribute("rnaID")%>";
	    }
	    if(pid=='4'){
	   		window.location="rna.action?m=frontAdRnaList&page=${dataList.totalPage}&NCBISpeciesID=<%=request.getAttribute("NCBISpeciesID")%>&pageSize="+pageSize+"&chromosomeRef=<%=request.getAttribute("chromosomeRef")%>&rnaID=<%=request.getAttribute("rnaID")%>";
	    }
	}
</script>
</body>
