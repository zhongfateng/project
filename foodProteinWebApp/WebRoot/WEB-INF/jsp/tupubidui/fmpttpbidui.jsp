...
<script type="text/javascript" src="<%=path%>/resources/js/tupubidui/jquery.min.js"></script>
<script type="text/javascript" src="<%=path%>/resources/js/tupubidui/service.min.js"></script>
...
<script src="<%=path%>/resources/js/tupubidui/highstock.min.js"></script>
<script src="<%=path%>/resources/js/tupubidui/modules/exporting.js"></script>
...
for(var i=0;i<obj.length;i++)
{
 ...
 { 
 j++;
 filearray.push(obj[i].value);
	}

}
if(j!=2)
{
ymPrompt.alert("请选择两个！！");
}
else
{

$.ajax({
	url:"fmpttp.action?m=frontGetDuiBiDu",
	data:"first="+filearray[0]+"&sencond="+filearray[1],
	async : false,
	error:function(){
						ymPrompt.alert("比对出错请检查上传文件的格式是否符合平台要求");
						},
	success: function(data){
	$("#similarity").html("<label><p><font color=#FF0000>所选二者质谱图相似度为 "+data+"%</p></label>");
	}
	});
...
<table width="965" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid; border-color:#d0ced1; border-width:0px 1px 1px 1px;  margin-bottom:5px;">
  ...
  <form id="myform">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="background-image:url(${skinPath}images/lefttext-bg.jpg); background-position:bottom; background-repeat:repeat-x; margin-bottom:5px;">
      ...
      <tr>
        <td height="29">&nbsp;</td>
        <td colspan="4" valign="top" class="red12" style="padding-left:75px;">请输入物种名，然后选择要查找的结果项</td>
        </tr>
      <tr>
        <td height="50">&nbsp;</td>
        <td colspan="4" class="hei14" style="padding-left:45px;"><label>
          ...
          <span class="red12" >请上传本地 txt 格式文件</span>
          </label></td>
        </tr>
      <tr>
        <td height="20">&nbsp;</td>
        ...
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" height="64" border="0" cellpadding="0" cellspacing="0">
             ...
             <table width="100%" height="64" border="0" cellpadding="0" cellspacing="0">
              <tr>
              	<td ><img src="${skinPath}images/tupu/abs.jpg"/>
              
				</td>
              </tr>
             <tr>
              <td><div id="filenames"  class="hei12" style="background:#ffffee; margin:5px;border:#ffe2b4 solid 1px"></div>
              </td></tr>    
                     
              <tr>
              	<td ><img src="${skinPath}images/tupu/bjbj.jpg"/>
              
				</td>
              </tr>
              <tr>
              <td>
              <div id="similarity"  class="hei12" style="background:#ffffee; margin:5px;"></div>
