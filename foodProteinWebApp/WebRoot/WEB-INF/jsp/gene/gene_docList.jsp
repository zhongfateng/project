...
<script type="text/javascript">
	$(function(){
		...
		$("#select").change(function(){
			...
			window.location.href="gene.action?m=frontGeneDocList&ncbiGeneRef=${gene.ncbiGeneRef}&page=1&pageSize="+pageSize;
		});
        ...
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="dd_00">
                ...
                <tr>
                  <td width="100%" height="30" bgcolor="#FBF0B5" class="hei14" align="center">找到<span class="lanlink" id="d_sum">${pageBean.allRow}</span>条数据，共<span class="lanlink">${pageBean.totalPage}</span>页&nbsp;&nbsp;
                  <c:choose> 
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td width="100%" height="30" bgcolor="#FBF0B5" class="hei14" align="center">找到<span class="lanlink">${pageBean.allRow}</span>条数据，共<span class="lanlink">${pageBean.totalPage}</span>页&nbsp;&nbsp;
...
<script type="text/javascript">
	function changepage(pid){
	    ...
	    if(pid=='1'){
	    	window.location.href="gene.action?m=frontGeneDocList&page=1&ncbiGeneRef=${gene.ncbiGeneRef}&pageSize="+pageSize;
	    }
	    if(pid=='2'){
	    	window.location="gene.action?m=frontGeneDocList&page=${pageBean.currentPage-1}&ncbiGeneRef=${gene.ncbiGeneRef}&pageSize="+pageSize;
	    }
	    if(pid=='3'){
	    	window.location="gene.action?m=frontGeneDocList&page=${pageBean.currentPage+1}&ncbiGeneRef=${gene.ncbiGeneRef}&pageSize="+pageSize;
	    }
	    if(pid=='4'){
	   		window.location="gene.action?m=frontGeneDocList&page=${pageBean.totalPage}&ncbiGeneRef=${gene.ncbiGeneRef}&pageSize="+pageSize;
	    }
	}
</script>
</body>
