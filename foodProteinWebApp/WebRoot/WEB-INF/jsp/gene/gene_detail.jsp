...
<table width="965" height="692" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="734" height="692" valign="top"><table width="734" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="35" background="<%=request.getContextPath() %>/resources/images/gene/images/leftmenu-bg.jpg" class="hei16B">&nbsp;&nbsp;&nbsp;&nbsp;Summary</td>
     </tr>
    </table>
      <table width="734" border="0" cellpadding="0" cellspacing="0" style="border:solid; border-color:#d0ced1; border-width:0px 1px 1px 1px">
        <tr>
          <td valign="top"><table width="100%" height="61" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="33%" align="right" valign="top" class="eng14" style="padding:20px 10px;"><strong>
                  ...
                  Species   ID：<br />
                Organism：<br/>
                  Ncbi   Species ID：                </strong></td>
              <td width="67%" align="left" valign="top" style="padding:20px 10px;" class="eng14">${gene.gid}<br />
                ${gene.gname}<br />
                ${gene.chromosomeRef}<br />
                ${gene.chromosomeStart}<br />
                ${gene.chromosomeEnd}<br />
                ${gene.ncbiGeneRef}<br />
                ${gene.locusTag}<br />
                
                <c:if test="${gene.proteinId==''}">
                	<a href="rna.action?m=frontRnaDetail&rnaId=${gene.ncbiGeneRef}">RNA_${gene.ncbiGeneRef}
                	</a><br/>
                </c:if>
                
                 <c:if test="${gene.proteinId!=''}">
                <a href="protein.action?m=frontProteinDetail&proteinId=${gene.proteinId}">${gene.proteinId}
                </a><br />
                </c:if>
                ...
                ${gene.speciesId}<br />
                ${gene.organism}<br />
                <a href="http://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?id=${gene.ncbiSpeciesId}" target="_blank">${gene.ncbiSpeciesId}
                </a></td>
            </tr>
          </table></td>
        </tr>
      ...
      <table width="734" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="35" background="<%=request.getContextPath() %>/resources/images/gene/images/leftmenu-bg.jpg" class="hei16B">&nbsp;&nbsp;&nbsp;&nbsp;Sequence </td>
        </tr>
      </table>
      <table width="734" border="0" cellpadding="0" cellspacing="0" style="border:solid; border-color:#d0ced1; border-width:0px 1px 1px 1px">
        <tr>
          <td valign="top" style="padding:20px 0"><table width="100%" height="150" border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="734" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="35" background="<%=request.getContextPath() %>/resources/images/gene/images/leftmenu-bg.jpg" class="hei16B">&nbsp;&nbsp;&nbsp;&nbsp;Related Bibliography</td>
        </tr>
      </table>
      <table width="734" border="0" cellpadding="0" cellspacing="0" style="border:solid; border-color:#d0ced1; border-width:0px 1px 1px 1px">
        <tr>
        ...
        <tr>
          <td valign="top">
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="dd_00">
                ...
                <tr>
                  <td width="100%" height="30" bgcolor="#FBF0B5" class="hei14" align="center">找到<span class="lanlink" id="d_sum">${pageBean.allRow}</span>条数据，<a href="gene.action?m=frontGeneDocList&ncbiGeneRef=${gene.ncbiGeneRef}&page=1&pageSize=10">显示更多</a>&nbsp;&nbsp;
    ...
    <td width="226" valign="top" bgcolor="#FFFFFF" style="padding-left:5px">
	  <table width="100%" cellspacing="0" background="<%=request.getContextPath() %>/resources/images/gene/images/right-bg.jpg">
        <tr>
      ...
      <table width="100%" cellspacing="0">
        <tr>
          <td height="30" style="padding-left: 20px;" background="<%=request.getContextPath() %>/resources/images/gene/images/right-bg.jpg"><span class="bai14">相关数据库检索
</span></td>
        </tr>
      </table>
      <table border="0" width="100%" cellspacing="0"  style="border:solid; border-width:0px 1px 1px 1px; border-color:#cbcbcb;margin-bottom:5px;">
        <tr>
          <td height="55px;" bgcolor="#F6FCFC" class="hei14" style="padding:2px 15px; background:url(<%=request.getContextPath()%>/resources/images/gene/images/jhesh_cbg.gif); background-position:bottom; background-repeat:repeat-x"><p>
