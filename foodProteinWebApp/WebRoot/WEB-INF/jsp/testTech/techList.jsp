...
<table width="965" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid; border-color:#d0ced1; border-width:0px 1px 1px 1px;  margin-bottom:5px;">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="background-image:url(<%=request.getContextPath()%>/resources/images/testTech/images/lefttext-bg.jpg); background-position:bottom; background-repeat:repeat-x; ">
      <tr>
        <td height="50">&nbsp;</td>
...
<table width="965" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="39" height="35"><img src="<%=request.getContextPath()%>/resources/images/testTech/images/leftmenu-bg01.jpg" width="39" height="35" /></td>
    <td background="<%=request.getContextPath()%>/resources/images/testTech/images/leftmenu-bg02.jpg" class="hei16B">检索结果</td>
    <td width="13"><img src="<%=request.getContextPath()%>/resources/images/testTech/images/leftmenu-bg03.jpg" width="13" height="35" /></td>
  </tr>
</table>
<table width="965" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid; border-color:#d0ced1; border-width:1px;  margin-bottom:5px;">
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0"   style=" background-color:#F1F9FC; margin-bottom:10px;">
          <tr>
            <td  class="hei14" style="padding:15px 40px;"><p>${testTech.cname}</p>
                <strong>技术简介：</strong>${testTech.overview}
                 <p class="hei14" ><strong>技术原理：</strong>${testTech.theory}<br />
                    <strong>技术应用：</strong>${testTech.apply}</p>
            </td>
          </tr>
        </table>
      </td>
