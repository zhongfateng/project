...
/**
 * SysUsersDetailCol entity. 
 * @author 狄巨礼 May 17, 2010 09:31:00 AM
 */
public class SysUsersDetailCol extends AbstractSysUsersDetailCol implements
	...
	/** default constructor */
	public SysUsersDetailCol() {
	}

	/** minimal constructor */
	public SysUsersDetailCol(String colId) {
		super(colId);
	}

	public SysUsersDetailCol(String colId, String colName, Integer enabled,
			Integer filled, Integer length, Integer orderNum, String showForm,
			String dataSources, String type, String colItems) {
