...
/**
 * AbstractSysOrganizationsDetail entity provides the base persistence
 * definition of the SysOrganizationsDetail entity. 
 * @author 狄巨礼 May 17, 2010 09:31:00 AM
 */

public abstract class AbstractSysOrganizationsDetail implements
	...
	/** default constructor */
	public AbstractSysOrganizationsDetail() {
	}

	/** minimal constructor */
	public AbstractSysOrganizationsDetail(String id,
			SysOrganizations sysOrganizations) {
		this.id = id;
	...
	/** full constructor */
	public AbstractSysOrganizationsDetail(String id,
			SysOrganizations sysOrganizations, String char01, String char02,
			String char03, String char04, String char05, String char06,
			String char07, String char08, String char09, String char10,
			String char11, String char12, String char13, String char14,
			String char15, String char16, String char17, String char18,
			String char19, String char20, String char21, String char22,
			String char23, String char24, String char25, String char26,
			String char27, String char28, String char29, String char30,
			Date date01, Date date02, Date date03, Date date04, Date date05,
			Date date06, Date date07, Date date08, Date date09, Date date10,
			double float01, double float02, double float03, double float04,
			double float05, double float06, double float07, double float08,
			double float09, double float10) {
		this.id = id;
		this.sysOrganizations = sysOrganizations;
		this.char01 = char01;
		this.char02 = char02;
