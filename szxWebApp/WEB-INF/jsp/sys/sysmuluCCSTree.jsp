...
function select_one_it(str,cn){
		 var objcn  = null;
		  //alert("1"+str+cn)
		 obj1 = opener.document.getElementById("chin_thematic");
		 objcn = opener.document.getElementById("chin_typenum");
						...
						<tr style="background-color: #E6F2FF;">
							...
							<td width="95%" valign="top">
								<a href="#" onclick="select_one_it('${m[1]}','${i.index}');">
									${m[1]} ${m[3]} </a>
								<a href="sysmulu.action?m=frontTreeLeaf&treeId=${m[1]}";> <img
										src="${skinPath}images/pop_window_arrow_down.gif"
