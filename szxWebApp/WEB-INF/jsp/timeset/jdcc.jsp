...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="144" align="center"
					...
					class="txt_bt">
					<a href="pingjiaguize4.html" target="main">监督抽查不合格规则管理</a>
				</td>
				<td>
					&nbsp;
				</td>
		...
		<form action="timeset.action?m=toSaveOrUpdate1" name="form1" id="form1" method="post">
		<table width="100%" border="0" align="center" cellpadding="0"
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="97%" class="left_txt">
											<span class="left_ts">说明</span>:在设定信用等级计算截至时间后，在一定时期内是否存在监督抽查不合格记录是判断等级A的条件，此处对该数值进行设定。
										</td>
									</tr>
								</table>
							</td>
							...
							<td colspan="4">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="97%" class="left_txt">
											<span class="left_ts">说明</span>:在设定信用等级计算截至时间后，需要判断企业近期最近一次监督抽查不合格的时间与截止时间的间隔是否满足一定数值，此处对该数值进行设定。
										</td>
									</tr>
								</table>
							</td>
							...
							<td colspan="4">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="97%" class="left_txt">
											<span class="left_ts">说明</span>:如企业连续发生质量抽查不合格的情况，则在规定期限内是否连续发生质量抽查不合格的情况，为判断信用等级为C或D的条件。此处对连续发生的次数进行设定。
										</td>
									</tr>
								</table>
							</td>
