		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="144" align="center"
					...
					class="txt_bt">
					<span class="login_txt">行政许可评价规则管理</span>
				</td>
				<td>
					&nbsp;
				</td>
			...
			<tr>
				...
				<td>
					<table width="98%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td valign="middle">
							<form action="timeset.action?m=toSaveOrUpdate" name="form1" id="form1" method="post">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td colspan="2">
											<label>
												<span class="left_txt"> 
												<input name="times" id="times" type="text" value="${ts.tabnum}" class="input4" size="20"/>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="97%" class="left_txt">
											<span class="left_ts">说明</span>:实行行政许可管理的企业，如未满足行政许可要求，在规定的期限内通过整改达到要求，为判断信用等级为C或D的条件。此处设定整改期限的最大时间范围数值。
										</td>
									</tr>
								</table>
							</td>
