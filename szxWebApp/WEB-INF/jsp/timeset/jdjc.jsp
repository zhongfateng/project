...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="144" align="center"
					...
					class="txt_bt">
					<span class="login_txt">监督检查不合格规则管理</span>
				</td>
				<td>
					&nbsp;
				</td>
		...
		<form action="timeset.action?m=toSaveOrUpdate1" method="post" name="form1" id="form1">
		<table width="100%" border="0" align="center" cellpadding="0"
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="97%" class="left_txt">
											<span class="left_ts">说明</span>:在设定信用等级计算截至时间后，在一定时期内是否存在监督检查不合格记录是判断等级A的条件，此处对该数值进行设定。
										</td>
									</tr>
								</table>
							</td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td colspan="2">
											<label>
												<span class="left_txt"> 
												<input name="times2" id="times2" type="text" class="input4" value="${ts.tabsometime}" size="20" /> </span>
											</label>
											<span class="left_txt">
												个月 &nbsp;&nbsp;&nbsp;&nbsp; 
											</span>
							...
							<td colspan="4">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="97%" class="left_txt">
											<span class="left_ts">说明</span>:设定信用等级计算截至时间后，判定近期最近一次监督检查不合格记录与截止时间的间隔，为信用等级为C或D的条件。此处对该数值进行设定。
										</td>
									</tr>
								</table>
							</td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td colspan="2">
											<label>
												<span class="left_txt"> 
												<input name="times3" id="times3" type="text" class="input4" value="${ts.tabtimes}" size="20" /> </span>
											</label>
											<span class="left_txt">
												次 &nbsp;&nbsp;&nbsp;&nbsp; 
											</span>
											<span id="info2" style="color: red"><%=request.getAttribute("info") %></span>
										</td>
									</tr>
								</table>
								<span class="left_txt"><br /> </span>
							...
							<td colspan="4">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="97%" class="left_txt">
											<span class="left_ts">说明</span>:如企业连续发生质量监督检查不合格的情况，则在规定期限内是否连续发生质量监督检查不合格的情况，为判断信用等级为C或D的条件。此处对连续发生的边界次数进行设定。
										</td>
									</tr>
								</table>
							</td>
