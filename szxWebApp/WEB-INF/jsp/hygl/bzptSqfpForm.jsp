	           ...
	           $("#deliverytype").formValidator({
				 ...
				 $("#sbmintButton").click(function(){
						if($.formValidator.pageIsValid('1')){
			               document.all.theFrom.action="bzptfp.action?m=sqFpSave";
...
function backPage(){
    document.all.frm1.action = "bzptczd.action?m=loadData";
	...
	<body>
		<form action="" method="post" name="theFrom">
			<input type="hidden" name="id" value="${bzptfp.id}" />
			<input type="hidden" name="czrId" value="${czrId}" />
			<input type="hidden" name="czdId" value="${czdId}" />
			...
			<table width="100%" class="table_nbw">
				<tr class="tr_nbw">
					...
					<td height="30" class="td_nbw_right">
						<input type="text" name="fptt" id="fptt" value="${bzptfp.fptt}"
							size="40" />
				...
				<tr class="tr_nbw">
					...
					<td height="30" class="td_nbw_right">
						<input type="text" name="invoicecontent" id="invoicecontent"
							value="${bzptfp.invoicecontent}" size="40" />
				...
				<tr class="tr_nbw">
					...
					<td height="30" class="td_nbw_right">
						<input type="text" name="je" id="je" value="${czje}"
				...
				<tr class="tr_nbw">
					...
					<td height="30" class="td_nbw_right">
						<input type="text" name="receivename" id="receivename"
							value="${bzptfp.receivename}" size="40" />
				...
				<tr class="tr_nbw">
					...
					<td height="30" class="td_nbw_right">
						<input type="text" name="deliverytype" id="deliverytype"
							value="${bzptfp.deliverytype}" size="40" />
