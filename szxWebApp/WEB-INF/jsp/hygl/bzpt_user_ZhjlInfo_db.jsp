...
function changepage(pid){
	    var url="bzptzh.action?m=showQtZhjlDBInfo";
	    if(pid=='1'){
						...
						<tr>
							...
							<td height="25" align="left" width="677"
								...
								<span class="menu_p" style="padding-left: 10px"> <img
									...
									&nbsp;您的位置：个人中心-&gt;&gt; <span style="font-size: 12px;">会员充值记录查询-&gt;&gt;待充值列表</span>
								</span>
							</td>
									...
									<tr style="height: 21">
										<td>
											<img style="cursor: pointer"
												src="${skinPath}images/yczlbq.gif"
												onclick="changInfoFrame('bzptzh.action?m=showQtZhjlJSInfo');" />
										</td>
										<td style="width: 3">
											&nbsp;
										</td>
						...
						<c:forEach items="${dataList.list}" var="m" begin="0"
							...
							<tr>
								<td height="30" align="left" bgcolor="#FFFFFF" class="txt_p"
									width="30%">
									<fmt:formatDate value="${m.sqsj}" pattern="yyyy年MM月dd日" />
								</td>
								<td height="30" align="left" bgcolor="#FFFFFF" class="txt_p"
									width="30%">
									${m.je }
